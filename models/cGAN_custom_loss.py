...
incorrect_data = pd.read_csv(r'C:\Users\Andrew\PycharmProjects\pythonProject\models\sorted_valid_samples.csv')
...
df_generated.to_csv('generated_wpt_parameters_20240920_6.csv', index=False)
